...
jokeForm.addEventListener('submit', (event) => {
    ...
    addJokeXhr.open('POST', 'http://localhost:3000/api/jokes');
...
function like(id) {
    ...
    likeXhr.open('GET', 'http://localhost:3000/api/like?id='+id);
    likeXhr.send();
...
function dislike(id) {
    ...
    dislikeXhr.open('GET', 'http://localhost:3000/api/dislike?id='+id);
    dislikeXhr.send();
